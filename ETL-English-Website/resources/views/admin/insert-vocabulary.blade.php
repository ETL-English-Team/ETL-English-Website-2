            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Thêm từ vựng chủ đề <b>{{$topic->topic_name_vi}}</b></h4>
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 examination-question">
                    <div class="panel panel-primary text-center vocabulary-box">
                        <div class="panel-heading">
                            <h4 class="panel-title">Thêm từ vựng chủ đề <b>{{$topic->topic_name_vi}}</b></h4>
                        </div>
                        <div class="panel-body">
                            <form action="admin/insert-vocabulary" method="post" enctype="multipart/form-data">
                                ...
                                @endif
                                <input id="answer" type="hidden" class="form-control" name="topic_id" value="{{$topic->topic_id}}" required placeholder="Level">
                                <div class="row input-row">
                                    ...
                                    <div class="col-xs-9 col-sm-10 col-md-9 col-lg-10">
                                        <input id="answer" type="text" class="form-control" name="level" value="{{$topic->level}}" required placeholder="Level" readonly>
                                    </div>
                                </div>
                                <div class="row input-row">
                                    <div class="col-xs-3 col-sm-2 col-md-3 col-lg-2">
                                    ...
                                    <div class="col-xs-9 col-sm-10 col-md-9 col-lg-10">
                                        <input id="answer" type="text" class="form-control" name="topic_name_en" value="{{$topic->topic_name_en}}" required placeholder="Level" readonly>
                                    </div>
                                </div>
                                <div class="row input-row">
                                    <div class="col-xs-3 col-sm-2 col-md-3 col-lg-2">
                                    ...
                                    <div class="col-xs-9 col-sm-10 col-md-9 col-lg-10">
                                        <input id="answer" type="text" class="form-control" name="word"  required placeholder="Nhập từ vựng bạn muốn thêm">
                                    </div>
                                </div>
                                <div class="row input-row">
                                    <div class="col-xs-3 col-sm-2 col-md-3 col-lg-2">
                                    ...
                                    <div class="col-xs-9 col-sm-10 col-md-9 col-lg-10">
                                        <input id="answer" type="text" class="form-control" name="spelling" required placeholder="Nhập phiên âm của từ">
                                    </div>
                                </div>
                                <div class="row input-row">
                                    <div class="col-xs-3 col-sm-2 col-md-3 col-lg-2">
                                    ...
                                    <div class="col-xs-9 col-sm-10 col-md-9 col-lg-10">
                                        <input id="answer" type="text" class="form-control" name="meaning_1"  required placeholder="Nhập nghĩa của từ (Ví dụ: (n) gia đình)">
                                    </div>
                                </div>
                                 <div class="row input-row">
                                    <div class="col-xs-3 col-sm-2 col-md-3 col-lg-2">
                                    ...
                                    <div class="col-xs-9 col-sm-10 col-md-9 col-lg-10">
                                        <input id="answer" type="text" class="form-control" name="meaning_2" placeholder="Nhập nghĩa thứ 2 của từ (nếu có)">
                                    </div>
                                </div>
                                 <div class="row input-row">
                                    <div class="col-xs-3 col-sm-2 col-md-3 col-lg-2">
                                    ...
                                    <div class="col-xs-9 col-sm-10 col-md-9 col-lg-10">
                                        <input id="answer" type="text" class="form-control" name="meaning_3" placeholder="Nhập nghĩa thứ 3 của từ (nếu có)">
                                    </div>
                                </div>
                                 <div class="row input-row">
                                    <div class="col-xs-3 col-sm-2 col-md-3 col-lg-2">
                                    ...
                                    <div class="col-xs-9 col-sm-10 col-md-9 col-lg-10">
                                        <input id="answer" type="text" class="form-control" name="example_sentence"  required placeholder="Nhập câu ví dụ tiếng anh cho từ">
                                    </div>
                                </div>
                                <div class="row input-row">
                                    <div class="col-xs-3 col-sm-2 col-md-3 col-lg-2">
                                ...
                                <div class="row input-row">
                                    ...
                                    <div class="col-xs-6 col-sm-4 col-md-4 col-lg-2">
                                        <input type="submit" class="btn-insert-topic btn-success" name="btn_add_voca" value="Thêm">
                                    </div>
                                    <div class="col-xs-6 col-sm-4 col-md-4 col-lg-2">
