            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Cập nhật chủ đề</h4>
                        <ol class="hidden-xs breadcrumb pull-right">
                            <a href="admin/topic-list"><button type="submit" class="btn-link">Về danh sách chủ đề</button></a>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 examination-question">
                    <div class="panel panel-primary text-center vocabulary-box">
                        <div class="panel-heading">
                            <h4 class="panel-title">Cập nhật chủ đề</h4>
                        </div>
                        <div class="panel-body">
                            <form action="admin/update-topic" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row input-row">
                                    <div class="col-xs-3 col-sm-2 col-md-3 col-lg-2">
                                        <div class="input-title">Mã chủ đề</div>
                                    </div>
                                    <div class="col-xs-9 col-sm-10 col-md-9 col-lg-10">
                                        <input id="answer" type="text" class="form-control" name="topic_id" value="{{$topic->topic_id}}" required placeholder="Level" readonly>
                                    </div>
                                </div>
                                <div class="row input-row">
                                    <div class="col-xs-3 col-sm-2 col-md-3 col-lg-2">
                                    ...
                                    <div class="col-xs-9 col-sm-10 col-md-9 col-lg-10">
                                        <input id="answer" type="text" class="form-control" name="topic_name_en" value="{{$topic->topic_name_en}}"  required placeholder="Nhập tên chủ đề (english)">
                                    </div>
                                </div>
                                <div class="row input-row">
                                    <div class="col-xs-3 col-sm-2 col-md-3 col-lg-2">
                                    ...
                                    <div class="col-xs-9 col-sm-10 col-md-9 col-lg-10">
                                        <input id="answer" type="text" class="form-control" name="topic_name_vi" value="{{$topic->topic_name_vi}}" required placeholder="Nhập tên chủ đề (vietnamese)">
                                    </div>
                                </div>
                                <div class="row input-row">
                                    <div class="col-xs-3 col-sm-2 col-md-3 col-lg-2">
                                ...
                                <div class="row input-row">
                                    ...
                                    <div class="col-xs-6 col-sm-4 col-md-4 col-lg-2">
                                        <input type="submit" class="btn-insert-topic btn-success" name="btn_update_topic" value="Lưu">
                                    </div>
                                    <div class="col-xs-6 col-sm-4 col-md-4 col-lg-2">
